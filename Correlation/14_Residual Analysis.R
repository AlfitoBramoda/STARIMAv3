...
# LOAD MODEL OUTPUT
# ============================================================================
load("output/11_starima_correlation.RData")   # contains correlation_results$model & residuals

resid_matrix <- correlation_results$residuals
if (is.null(resid_matrix)) stop("❌ Residuals not found in correlation_results$model")
