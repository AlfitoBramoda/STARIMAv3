...
model_summary <- data.frame(
  Model = model_name,
  Spatial_Weight_Type = "correlation (Equal Weights)",
...
significant_params <- sum(correlation_coef$Significant == "Yes")
...
cat(sprintf("📊 Final Model Selected: %s — correlation Spatial Weights\n", model_name))
