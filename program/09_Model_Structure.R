...
# ============================================================================
# CONTOH MENAMPILKAN PLOT UNTUK SATU BOBOT (DENGAN ERROR HANDLING)
# ============================================================================
# Misal untuk uniform AR dan MA
if (!is.null(plots$uniform_AR$plot)) {
  print(plots$uniform_AR$plot)
} else {
  cat("⚠️ Uniform AR plot not available\n")
}

if (!is.null(plots$uniform_MA$plot)) {
  print(plots$uniform_MA$plot)
} else {
  cat("⚠️ Uniform MA plot not available\n")
}
