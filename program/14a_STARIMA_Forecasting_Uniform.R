...
# Load data
load("output/10a_starima_uniform.RData")   # starima_uniform
...
save(results_uniform, file = "output/14a_forecast_uniform.RData")
cat("💾 Results saved to: output/14a_forecast_uniform.RData\n")