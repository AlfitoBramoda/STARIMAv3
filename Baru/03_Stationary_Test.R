# ============================================================================
# 02_Stationarity_Test.R - Unit Root and Stationarity Testing
# ============================================================================
...
cat("🔍 Stationarity Testing Started...\n")
...
cat("📊 Data loaded: train_data (", nrow(train_data), "x", ncol(train_data), ")\n")
...
cat("📋 STATIONARITY ASSESSMENT SUMMARY:\n")
cat(paste(rep("=", 50), collapse = ""), "\n")
...
cat("\n🔬 Methodology: Dual testing approach (ADF + KPSS) for robust stationarity assessment\n")
...
save(stationarity_results, rainfall_matrix, coordinates, dates,
     file = "output/03_stationarity_results.RData")

cat("\n💾 Results saved to: output/03_stationarity_results.RData\n")
