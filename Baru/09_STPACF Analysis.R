...
plot1 <- create_stpacf_heatmap(stpacf_uniform, "Uniform Weights", "plots/09_stpacf_uniform_heatmap.png")
plot2 <- create_stpacf_heatmap(stpacf_distance, "Distance Weights", "plots/09_stpacf_distance_heatmap.png")
plot3 <- create_stpacf_heatmap(stpacf_correlation, "Correlation Weights", "plots/09_stpacf_correlation_heatmap.png")
...
pacf_plot1 <- create_pacf_style_plot(stpacf_uniform, "Uniform Weights", "plots/09_stpacf_uniform_pacf.png")
pacf_plot2 <- create_pacf_style_plot(stpacf_distance, "Distance Weights", "plots/09_stpacf_distance_pacf.png")
pacf_plot3 <- create_pacf_style_plot(stpacf_correlation, "Correlation Weights", "plots/09_stpacf_correlation_pacf.png")
...
if (!is.null(pacf_plot1) && !is.null(pacf_plot2) && !is.null(pacf_plot3)) {
  ...
  # cat("✅ Combined PACF comparison plot saved: plots/089stpacf_combined_pacf.png\n")
}
...
save(stpacf_uniform, stpacf_distance, stpacf_correlation,
     ...
     file = "output/09_stpacf_analysis.RData")
...
cat("📁 Next file: 10_Model_Structure.R\n\n")
