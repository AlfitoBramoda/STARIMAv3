...
# LOAD DATA
# ============================================================================
load("output/11a_starima_uniform.RData")  # Model & residuals
...
cat("✅ Visualization saved: plots/12starima_rmse_per_region_fixed.png\n")
...
save(region_metrics, p_rmse, file = "output/12_starima_evaluation_per_region_fixed.RData")
