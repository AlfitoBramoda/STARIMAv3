...
# STARIMA Estimation (correlation Weights, SLAG 1 Only)
# ============================================================================
...
# ------------------------------ Data Loading --------------------------------
req_files <- c(
  "output/09_stpacf_correlation_only.RData",
...
cat("=== STARIMA ESTIMATION - correlation WEIGHTS (SLAG 1 ONLY) ===\n\n")
...
fit <- try(
  starma(data = data_input, wlist = wlist_correlation, ar = ar_mask, ma = ma_mask),
  silent = TRUE
)
...
cat("\n=== STARIMA ESTIMATION COMPLETED - correlation WEIGHTS (SLAG 1 ONLY) ===\n")
