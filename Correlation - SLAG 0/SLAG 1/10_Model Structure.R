# ============================================================================
# STARMA Forecasting Pipeline - Phase 3: STARIMA Estimation (Correlation SLAG 1)
# File: 10_Model_Structure_Correlation_SLAG1.R
# Purpose: Create AR/MA mask matrices for correlation weight type + SLAG 1
# Author: STARMA Analysis
# Date: 2024
# ============================================================================

# Load required data with error handling
if (file.exists("output/08_stacf_correlation_95only.RData")) {
...
cat("=== STARMA MODEL STRUCTURE DEFINITION (CORRELATION WEIGHTS - SLAG 1) ===\n\n")
...
# ============================================================================
# PROCESS CORRELATION WEIGHTS - SLAG 1
# ============================================================================
...
# SAVE RESULTS
# ============================================================================
save(model_structures, file = "output/10_model_structure_correlation_weights.RData")

cat("\n💾 RESULTS SAVED:\n")
cat("================\n")
cat("✅ Model structures saved to: output/10_model_structure_correlation_weights.RData\n")
