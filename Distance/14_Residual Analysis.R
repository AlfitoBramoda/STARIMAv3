...
# File: 14_STARIMA_Residual_Visualization.R
# Purpose: Visualize residual diagnostics for STARIMA model (Distance Weights)
# Author: STARMA Analysis
# Date: 2024
# ============================================================================

cat("🚀 Starting STARIMA Residual Visualization (Distance Weights)...\n\n")
...
# LOAD MODEL OUTPUT
# ============================================================================
load("output/11_starima_distance.RData")   # contains distance_results$model & residuals

resid_matrix <- distance_results$residuals
if (is.null(resid_matrix)) stop("❌ Residuals not found in distance_results$model")
...
for (r in regions) {
  ...
  ggsave(paste0("plots/14_residual_timeseries_", r, ".png"), 
...
for (r in regions) {
  ...
  ggsave(paste0("plots/14_residual_histogram_", r, ".png"),
...
for (r in regions) {
  ...
  png(paste0("plots/14_residual_acf_pacf_", r, ".png"),
...
save(resid_matrix, ts_plots, hist_plots,
     file = "output/14_starima_residual_visualization.RData")

cat("\n💾 All residual plots saved to 'plots/' folder.\n")
cat("📁 Results summary saved to: output/14_starima_residual_visualization.RData\n\n")
cat("🎯 Residual diagnostics completed successfully.\n")
cat("Next: proceed to 15_STARIMA_Forecasting_Distance.R for forecasting.\n")